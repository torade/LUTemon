...
public class LutemonItemActivity {
    ...
    public static class LutemonViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView getWinsText() {
            return winsText;
        }

        public TextView getBattleCountText() {
            return battleCountText;
        }

        public TextView getTrainingCountText() {
            return trainingCountText;
        }
